...
const dictionaries: Record<Language, TranslationDictionary> = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'VIREKA Space helps distinguish what is happening from how it may be interpreted, so responses begin from clearer understanding.',
    ...
    onboarding: {
      ...
      defaultBody: {
        ...
        usefulWhenList: [
          ...
          'implicit interpretations may be shaping the situation',
    ...
    clarify: {
      ...
      descriptionParagraph: 'Vireka distinguishes what appears, how the situation may be interpreted, and what remains unclear, so response can begin from clearer structure.',
      ...
      whatAppearsToBeHappening: 'Appears',
      interpretation: 'Interpretation',
      whatMayRemainUnclear: 'Unclear',
    ...
    aiInteraction: {
      ...
      descriptionParagraph: 'VIREKA Space helps distinguish what appears from how the situation may be interpreted, improving clarity of interaction with AI.',
      handoffSubtitle: 'Use clarified structure to guide what you want AI to do next',
      inputLabel: 'What is happening in the AI interaction?',
      inputPlaceholder: 'Describe the prompt, the output, or what feels unclear',
      handoffInputPlaceholder: 'Describe what you want AI to help you do next',
      ...
      yourInput: 'Your input',
      whatAppearsToBeHappening: 'Appears',
      whatMayBeAssumed: 'Interpretation',
      whatMayRemainUnclear: 'Unclear',
      ...
      sections: {
        function: {
          ...
          content: [
            ...
            'Sometimes a situation feels difficult not because it is complex, but because several interpretations seem possible at the same time, each suggesting a slightly different direction. Certain elements feel clear, others feel uncertain, and some readings of the situation may already be taking shape without being fully seen. When interpretation is unclear, decisions can feel pressured, and prompts can feel harder to form.',
      ...
      questions: {
        ...
        worksWithAI: {
          ...
          answer: [
            ...
            'It helps clarify what is being asked, how the situation may be read, and what remains unclear, so that AI interaction can begin from a more structured starting point rather than from an unformed or ambiguous prompt.',
          ],
        },
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: 'VIREKA Space ayuda a distinguir lo que sucede de cómo puede interpretarse, para que las respuestas partan de una comprensión más clara.',
    ...
    onboarding: {
      ...
      defaultBody: {
        ...
        usefulWhenList: [
          ...
          'las lecturas implícitas pueden estar influyendo en la interpretación',
    ...
    clarify: {
      ...
      descriptionParagraph: 'Vireka distingue lo que aparece, cómo puede interpretarse la situación y lo que permanece poco claro para que la respuesta pueda comenzar desde una estructura más clara.',
      ...
      whatAppearsToBeHappening: 'Aparece',
      interpretation: 'Interpretación',
      whatMayRemainUnclear: 'Poco claro',
    ...
    aiInteraction: {
      ...
      descriptionParagraph: 'VIREKA Space ayuda a distinguir lo que aparece de cómo puede interpretarse la situación, mejorando la claridad de la interacción con la IA.',
      handoffSubtitle: 'Usa la estructura ya clarificada para guiar lo que quieres que la IA haga después',
      ...
      handoffInputPlaceholder: 'Describe en qué quieres que la IA te ayude después',
      ...
      yourInput: 'Tu entrada',
      whatAppearsToBeHappening: 'Aparece',
      whatMayBeAssumed: 'Interpretación',
      whatMayRemainUnclear: 'Poco claro',
      ...
      clarificationPathDescription: 'Cada refinamiento ayuda a distinguir lo que hace la IA de cómo puede interpretarse su razonamiento.',
      response: 'Respuesta',
      listening: 'Escuchando...',
      mic: 'Micrófono',
      copyResult: 'Copiar resultado',
      ...
      sections: {
        function: {
          ...
          content: [
            ...
            'A veces una situación se siente difícil no porque sea compleja, sino porque varias interpretaciones parecen posibles al mismo tiempo, cada una sugiriendo una dirección ligeramente distinta. Algunos elementos se sienten claros, otros inciertos, y pueden estar tomando forma lecturas de la situación sin verse del todo. Cuando la interpretación no está clara, las decisiones pueden sentirse presionadas y los prompts más difíciles de formular.',
      ...
      questions: {
        ...
        worksWithAI: {
          ...
          answer: [
            ...
            'Ayuda a aclarar qué se está preguntando, cómo puede leerse la situación y qué permanece incierto, de modo que la interacción con la IA pueda comenzar desde un punto de partida más estructurado en lugar de un prompt ambiguo o poco formado.',
          ],
        },
        clarifyVsAIInteraction: {
          question:
  ...
  pt: {
    ...
    hero: {
      ...
      subtitle: 'VIREKA Space ajuda a distinguir o que acontece de como pode ser interpretado, para que as respostas partam de uma compreensão mais clara.',
    ...
    onboarding: {
      ...
      defaultBody: {
        ...
        usefulWhenList: [
          ...
          'leituras implícitas podem estar influenciando a interpretação',
    ...
    clarify: {
      ...
      descriptionParagraph: 'Vireka distingue o que aparece, como a situação pode ser interpretada e o que permanece pouco claro para que a resposta possa começar de uma estrutura mais clara.',
      inputLabel: 'Situação',
      ...
      whatMayRemainUnclear: 'Pouco claro',
    ...
    aiInteraction: {
      ...
      descriptionParagraph: 'VIREKA Space ajuda a distinguir o que aparece de como a situação pode ser interpretada, melhorando a clareza da interação com a IA.',
      handoffSubtitle: 'Use a estrutura já clarificada para orientar o que você quer que a IA faça em seguida',
      ...
      handoffInputPlaceholder: 'Descreva com o que você quer que a IA ajude em seguida',
      ...
      yourInput: 'Sua entrada',
      whatAppearsToBeHappening: 'Aparece',
      whatMayBeAssumed: 'Interpretação',
      whatMayRemainUnclear: 'Pouco claro',
      ...
      clarificationPathDescription: 'Cada refinamento ajuda a distinguir o que a IA está fazendo de como seu raciocínio pode ser interpretado.',
      response: 'Resposta',
      listening: 'Ouvindo...',
      mic: 'Microfone',
      copyResult: 'Copiar resultado',
      ...
      sections: {
        function: {
          ...
          content: [
            ...
            'Às vezes, uma situação parece difícil não porque seja complexa, mas porque várias interpretações parecem possíveis ao mesmo tempo, cada uma sugerindo uma direção ligeiramente diferente. Alguns elementos parecem claros, outros incertos, e certas leituras da situação podem estar se formando sem serem totalmente percebidas. Quando a interpretação não está clara, as decisões podem parecer pressionadas e os prompts mais difíceis de formular.',
      ...
      questions: {
        ...
        worksWithAI: {
          ...
          answer: [
            ...
            'Ele ajuda a esclarecer o que está sendo perguntado, como a situação pode ser lida e o que permanece incerto, para que a interação com a IA comece a partir de um ponto de partida mais estruturado, em vez de um prompt ambíguo ou pouco formado.',
          ],
        },
        clarifyVsAIInteraction: {
          question:
