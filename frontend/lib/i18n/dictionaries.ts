...
const dictionaries: Record<Language, TranslationDictionary> = {
  en: {
    ...
    aiInteraction: {
      ...
      inputPlaceholder: 'Describe the AI interaction as it currently appears.',
  ...
  es: {
    ...
    aiInteraction: {
      ...
      inputPlaceholder: 'Describe la interacción con IA tal como se presenta actualmente.',
  ...
  pt: {
    ...
    aiInteraction: {
      ...
      inputPlaceholder: 'Descreva a interação com IA como se apresenta atualmente.',
